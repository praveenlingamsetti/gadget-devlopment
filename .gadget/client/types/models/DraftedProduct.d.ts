...
import { Query, Select, DeepFilterNever, IDsList, PromiseOrLiveIterator, DraftedProduct, AvailableDraftedProductSelection, DraftedProductSort, DraftedProductFilter, CreateDraftedProductInput, UpdateDraftedProductInput, Scalars, UpsertDraftedProductInput } from "../types.js";
/**
...
*/
export type SelectedDraftedProductOrDefault<Options extends Selectable<AvailableDraftedProductSelection>> = DeepFilterNever<Select<DraftedProduct, DefaultSelection<AvailableDraftedProductSelection, Options, typeof DefaultDraftedProductSelection>>>;
export declare const DefaultDraftedProductSelection: {
...
declare const modelApiIdentifier: "draftedProduct";
declare const pluralModelApiIdentifier: "draftedProducts";
 ...
 **/
export type CreateDraftedProductResult<Options extends CreateDraftedProductOptions> = SelectedDraftedProductOrDefault<Options> extends void ? void : GadgetRecord<SelectedDraftedProductOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateDraftedProductResult<Options extends UpdateDraftedProductOptions> = SelectedDraftedProductOrDefault<Options> extends void ? void : GadgetRecord<SelectedDraftedProductOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertDraftedProductVariables = Omit<UpsertDraftedProductInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
 ...
 *
 **/
export type UpsertDraftedProductResult<Options extends UpsertDraftedProductOptions> = SelectedDraftedProductOrDefault<Options> extends void ? void : GadgetRecord<SelectedDraftedProductOrDefault<Options>>;
/**
...
export type DraftedProductManager = {
    ...
    create: {
        ...
        * * const draftedProductRecord = await api.draftedProduct.create({
          ...
          * });
        **/
        <Options extends CreateDraftedProductOptions>(variables: CreateDraftedProductVariables, options?: LimitToKnownKeys<Options, CreateDraftedProductOptions>): Promise<CreateDraftedProductResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const draftedProductRecord = await api.draftedProduct.create({
          ...
          * });
        **/
        <Options extends CreateDraftedProductOptions>(variables: FullyQualifiedCreateDraftedProductVariables, options?: LimitToKnownKeys<Options, CreateDraftedProductOptions>): Promise<CreateDraftedProductResult<Options>>;
        type: 'action';
        ...
        variables: {
            draftedProduct: {
                required: false;
                type: 'CreateDraftedProductInput';
            };
        };
        variablesType: (((FullyQualifiedCreateDraftedProductVariables | CreateDraftedProductVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateDraftedProductOptions>(inputs: (FullyQualifiedCreateDraftedProductVariables | CreateDraftedProductVariables)[], options?: LimitToKnownKeys<Options, CreateDraftedProductOptions>): Promise<CreateDraftedProductResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkCreateDraftedProductsInput!]';
            };
        };
    ...
    update: {
        ...
        * * const draftedProductRecord = await api.draftedProduct.update("123", {
          ...
          * });
        **/
        <Options extends UpdateDraftedProductOptions>(id: string, variables: UpdateDraftedProductVariables, options?: LimitToKnownKeys<Options, UpdateDraftedProductOptions>): Promise<UpdateDraftedProductResult<Options>>;
        /**
         * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const draftedProductRecord = await api.draftedProduct.update("123", {
          ...
          * });
        **/
        <Options extends UpdateDraftedProductOptions>(id: string, variables: FullyQualifiedUpdateDraftedProductVariables, options?: LimitToKnownKeys<Options, UpdateDraftedProductOptions>): Promise<UpdateDraftedProductResult<Options>>;
        type: 'action';
        ...
        variables: {
            ...
            draftedProduct: {
                required: false;
                type: 'UpdateDraftedProductInput';
            };
        };
        variablesType: ({
            id: string;
    ...
    bulkUpdate: {
        /**
          ...
          */
        <Options extends UpdateDraftedProductOptions>(inputs: (FullyQualifiedUpdateDraftedProductVariables | UpdateDraftedProductVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateDraftedProductOptions>): Promise<UpdateDraftedProductResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateDraftedProductsInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateDraftedProductVariables | UpdateDraftedProductVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableDraftedProductSelection;
    ...
    delete: {
        ...
        **/
        <Options extends DeleteDraftedProductOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteDraftedProductOptions>): Promise<DeleteDraftedProductResult<Options>>;
        type: 'action';
    ...
    bulkDelete: {
        /**
          ...
          */
        <Options extends DeleteDraftedProductOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteDraftedProductOptions>): Promise<DeleteDraftedProductResult<Options>[]>;
        type: 'action';
    ...
    upsert: {
        ...
        * * const result = await api.draftedProduct.upsert({
          ...
          * });
        **/
        <Options extends UpsertDraftedProductOptions>(variables: UpsertDraftedProductVariables, options?: LimitToKnownKeys<Options, UpsertDraftedProductOptions>): Promise<UpsertDraftedProductResult<Options>>;
        /**
         * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.draftedProduct.upsert({
          ...
          * });
        **/
        <Options extends UpsertDraftedProductOptions>(variables: FullyQualifiedUpsertDraftedProductVariables, options?: LimitToKnownKeys<Options, UpsertDraftedProductOptions>): Promise<UpsertDraftedProductResult<Options>>;
        type: 'action';
        ...
        variables: {
            ...
            draftedProduct: {
                required: false;
                type: 'UpsertDraftedProductInput';
            };
        };
        variablesType: (((FullyQualifiedUpsertDraftedProductVariables | UpsertDraftedProductVariables)) | undefined);
        hasAmbiguousIdentifier: false;
        paramOnlyVariables: ['on'];
        hasReturnType: {
            '... on CreateDraftedProductResult': {
                hasReturnType: false;
            };
            '... on UpdateDraftedProductResult': {
                hasReturnType: false;
            };
        };
        acceptsModelInput: true;
    ...
    bulkUpsert: {
        /**
          ...
          */
        <Options extends UpsertDraftedProductOptions>(inputs: (FullyQualifiedUpsertDraftedProductVariables | UpsertDraftedProductVariables)[], options?: LimitToKnownKeys<Options, UpsertDraftedProductOptions>): Promise<any[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpsertDraftedProductsInput!]';
            };
        };
...
/**
 * A manager for the draftedProduct model with all the available operations for reading and writing to it.*/
export declare const DraftedProductManager: {
