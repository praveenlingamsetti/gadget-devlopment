...
import { Query, Select, DeepFilterNever, IDsList, PromiseOrLiveIterator, GadgetInfo, AvailableGadgetInfoSelection, GadgetInfoSort, GadgetInfoFilter, CreateGadgetInfoInput, UpdateGadgetInfoInput, Scalars, UpsertGadgetInfoInput } from "../types.js";
/**
...
*/
export type SelectedGadgetInfoOrDefault<Options extends Selectable<AvailableGadgetInfoSelection>> = DeepFilterNever<Select<GadgetInfo, DefaultSelection<AvailableGadgetInfoSelection, Options, typeof DefaultGadgetInfoSelection>>>;
export declare const DefaultGadgetInfoSelection: {
...
declare const modelApiIdentifier: "gadgetInfo";
declare const pluralModelApiIdentifier: "gadgetInfos";
 ...
 **/
export type CreateGadgetInfoResult<Options extends CreateGadgetInfoOptions> = SelectedGadgetInfoOrDefault<Options> extends void ? void : GadgetRecord<SelectedGadgetInfoOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateGadgetInfoResult<Options extends UpdateGadgetInfoOptions> = SelectedGadgetInfoOrDefault<Options> extends void ? void : GadgetRecord<SelectedGadgetInfoOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertGadgetInfoVariables = Omit<UpsertGadgetInfoInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
 ...
 *
 **/
export type UpsertGadgetInfoResult<Options extends UpsertGadgetInfoOptions> = SelectedGadgetInfoOrDefault<Options> extends void ? void : GadgetRecord<SelectedGadgetInfoOrDefault<Options>>;
/**
...
export type GadgetInfoManager = {
    ...
    create: {
        ...
        * * const gadgetInfoRecord = await api.gadgetInfo.create({
          ...
          * });
        **/
        <Options extends CreateGadgetInfoOptions>(variables: CreateGadgetInfoVariables, options?: LimitToKnownKeys<Options, CreateGadgetInfoOptions>): Promise<CreateGadgetInfoResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const gadgetInfoRecord = await api.gadgetInfo.create({
          ...
          * });
        **/
        <Options extends CreateGadgetInfoOptions>(variables: FullyQualifiedCreateGadgetInfoVariables, options?: LimitToKnownKeys<Options, CreateGadgetInfoOptions>): Promise<CreateGadgetInfoResult<Options>>;
        type: 'action';
        ...
        variables: {
            gadgetInfo: {
                required: false;
                type: 'CreateGadgetInfoInput';
            };
        };
        variablesType: (((FullyQualifiedCreateGadgetInfoVariables | CreateGadgetInfoVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateGadgetInfoOptions>(inputs: (FullyQualifiedCreateGadgetInfoVariables | CreateGadgetInfoVariables)[], options?: LimitToKnownKeys<Options, CreateGadgetInfoOptions>): Promise<CreateGadgetInfoResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkCreateGadgetInfosInput!]';
            };
        };
    ...
    update: {
        ...
        * * const gadgetInfoRecord = await api.gadgetInfo.update("123", {
          ...
          * });
        **/
        <Options extends UpdateGadgetInfoOptions>(id: string, variables: UpdateGadgetInfoVariables, options?: LimitToKnownKeys<Options, UpdateGadgetInfoOptions>): Promise<UpdateGadgetInfoResult<Options>>;
        /**
         * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const gadgetInfoRecord = await api.gadgetInfo.update("123", {
          ...
          * });
        **/
        <Options extends UpdateGadgetInfoOptions>(id: string, variables: FullyQualifiedUpdateGadgetInfoVariables, options?: LimitToKnownKeys<Options, UpdateGadgetInfoOptions>): Promise<UpdateGadgetInfoResult<Options>>;
        type: 'action';
    ...
    bulkUpdate: {
        /**
          ...
          */
        <Options extends UpdateGadgetInfoOptions>(inputs: (FullyQualifiedUpdateGadgetInfoVariables | UpdateGadgetInfoVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateGadgetInfoOptions>): Promise<UpdateGadgetInfoResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateGadgetInfosInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateGadgetInfoVariables | UpdateGadgetInfoVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableGadgetInfoSelection;
    ...
    delete: {
        ...
        **/
        <Options extends DeleteGadgetInfoOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteGadgetInfoOptions>): Promise<DeleteGadgetInfoResult<Options>>;
        type: 'action';
    ...
    bulkDelete: {
        /**
          ...
          */
        <Options extends DeleteGadgetInfoOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteGadgetInfoOptions>): Promise<DeleteGadgetInfoResult<Options>[]>;
        type: 'action';
    ...
    upsert: {
        ...
        * * const result = await api.gadgetInfo.upsert({
          ...
          * });
        **/
        <Options extends UpsertGadgetInfoOptions>(variables: UpsertGadgetInfoVariables, options?: LimitToKnownKeys<Options, UpsertGadgetInfoOptions>): Promise<UpsertGadgetInfoResult<Options>>;
        /**
         * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.gadgetInfo.upsert({
          ...
          * });
        **/
        <Options extends UpsertGadgetInfoOptions>(variables: FullyQualifiedUpsertGadgetInfoVariables, options?: LimitToKnownKeys<Options, UpsertGadgetInfoOptions>): Promise<UpsertGadgetInfoResult<Options>>;
        type: 'action';
        ...
        variables: {
            ...
            gadgetInfo: {
                required: false;
                type: 'UpsertGadgetInfoInput';
            };
        };
        variablesType: (((FullyQualifiedUpsertGadgetInfoVariables | UpsertGadgetInfoVariables)) | undefined);
        hasAmbiguousIdentifier: false;
        paramOnlyVariables: ['on'];
        hasReturnType: {
            '... on CreateGadgetInfoResult': {
                hasReturnType: false;
            };
            '... on UpdateGadgetInfoResult': {
                hasReturnType: false;
            };
        };
        acceptsModelInput: true;
    ...
    bulkUpsert: {
        /**
          ...
          */
        <Options extends UpsertGadgetInfoOptions>(inputs: (FullyQualifiedUpsertGadgetInfoVariables | UpsertGadgetInfoVariables)[], options?: LimitToKnownKeys<Options, UpsertGadgetInfoOptions>): Promise<any[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpsertGadgetInfosInput!]';
            };
        };
...
/**
 * A manager for the gadgetInfo model with all the available operations for reading and writing to it.*/
export declare const GadgetInfoManager: {
