...
/** Context of the `create` action on the `shopifyInventoryLevel` model. */
export interface CreateShopifyInventoryLevelActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyInventoryLevel?: { canDeactivate?: boolean;deactivationAlert?: string;adminGraphqlApiId?: string;available?: number;shopifyUpdatedAt?: string; };
};
  /**
...
/** Context of the `update` action on the `shopifyInventoryLevel` model. */
...
/** Context of the `delete` action on the `shopifyInventoryLevel` model. */
