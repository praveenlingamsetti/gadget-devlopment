...
export interface CreateShopifyProductActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyProduct?: { id?: string;hasVariantsThatRequiresComponents?: boolean;body?: string;handle?: string;productType?: string;shopifyCreatedAt?: string;publishedAt?: string;status?: string | string[];shopifyUpdatedAt?: string;tags?: string;templateSuffix?: string;title?: string;vendor?: string;category?: string;compareAtPriceRange?: string;productCategory?: string; };
};
  /**
