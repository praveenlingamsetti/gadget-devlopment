...
/** Context of the `create` action on the `gadgetInfo` model. */
export interface CreateGadgetInfoActionContext extends AmbientContext {
  /**
...
/** Context of the `update` action on the `gadgetInfo` model. */
export interface UpdateGadgetInfoActionContext extends AmbientContext {
  /**
  * The model this action is operating on
  */
  model: NotYetTyped;
...
/** Context of the `delete` action on the `gadgetInfo` model. */
export interface DeleteGadgetInfoActionContext extends AmbientContext {
  /**
  * The model this action is operating on
  */
  model: NotYetTyped;
