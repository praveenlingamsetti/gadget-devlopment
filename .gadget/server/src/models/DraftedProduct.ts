...
/** Context of the `create` action on the `draftedProduct` model. */
export interface CreateDraftedProductActionContext extends AmbientContext {
  /**
  ...
  */
  params: {
draftedProduct?: { orderId?: string;productId?: string;productTitle?: string;relatedProduct?: string;shop?: string;swatchId?: string;type?: string;variant?: string; };
};
  /**
...
/** Context of the `update` action on the `draftedProduct` model. */
export interface UpdateDraftedProductActionContext extends AmbientContext {
  /**
  * The model this action is operating on
  */
  model: NotYetTyped;
...
/** Context of the `delete` action on the `draftedProduct` model. */
export interface DeleteDraftedProductActionContext extends AmbientContext {
  /**
  * The model this action is operating on
  */
  model: NotYetTyped;
