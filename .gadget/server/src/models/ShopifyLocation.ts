...
/** Context of the `create` action on the `shopifyLocation` model. */
export interface CreateShopifyLocationActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyLocation?: { id?: string;active?: boolean;address1?: string;address2?: string;city?: string;country?: string;countryCode?: string;legacy?: boolean;localizedCountryName?: string;localizedProvinceName?: string;name?: string;phone?: string;province?: string;provinceCode?: string;shopifyCreatedAt?: string;shopifyUpdatedAt?: string;zipCode?: string; };
};
  /**
...
/** Context of the `update` action on the `shopifyLocation` model. */
...
/** Context of the `delete` action on the `shopifyLocation` model. */
