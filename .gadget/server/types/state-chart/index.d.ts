...
/** Persist the new state into the model record */ export declare const updateState: ({ api, model, record, scope, logger }: ActionContext, newState: StateValue, stateHistory: StateHistoryValue) => Promise<void>;
