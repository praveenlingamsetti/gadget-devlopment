...
/** Context of the `create` action on the `shopifyInventoryItem` model. */ export interface CreateShopifyInventoryItemActionContext extends AmbientContext {
    /**
...
/** Context of the `update` action on the `shopifyInventoryItem` model. */ export interface UpdateShopifyInventoryItemActionContext extends AmbientContext {
    /**
  * The model this action is operating on
  */ model: NotYetTyped;
    /**
...
/** Context of the `delete` action on the `shopifyInventoryItem` model. */ export interface DeleteShopifyInventoryItemActionContext extends AmbientContext {
    /**
  * The model this action is operating on
  */ model: NotYetTyped;
    /**
