...
/** Context of the `create` action on the `shopifyOrderLineItem` model. */ export interface CreateShopifyOrderLineItemActionContext extends AmbientContext {
    /**
...
/** Context of the `update` action on the `shopifyOrderLineItem` model. */ export interface UpdateShopifyOrderLineItemActionContext extends AmbientContext {
    /**
  * The model this action is operating on
  */ model: NotYetTyped;
    /**
...
/** Context of the `delete` action on the `shopifyOrderLineItem` model. */ export interface DeleteShopifyOrderLineItemActionContext extends AmbientContext {
    /**
  * The model this action is operating on
  */ model: NotYetTyped;
    /**
