...
/** Context of the `create` action on the `shopifyOrder` model. */ export interface CreateShopifyOrderActionContext extends AmbientContext {
    /**
  ...
  */ params: {
        shopifyOrder?: {
            ...
            totalCashRoundingAdjustment?: string;
            fulfillmentsCount?: string;
            cancellation?: string;
            risk?: string;
            transactionsCount?: string;
            shopifyProtect?: string;
            taxExempt?: boolean;
            ...
            currentTotalDiscountsSet?: string;
            currentTotalDutiesSet?: string;
            currentTotalPrice?: string;
            currentTotalPriceSet?: string;
            currentTotalTax?: string;
            currentTotalTaxSet?: string;
            ...
            totalDiscountsSet?: string;
            totalLineItemsPrice?: string;
            totalLineItemsPriceSet?: string;
            totalOutstanding?: string;
            totalPrice?: string;
            totalPriceSet?: string;
            totalShippingPriceSet?: string;
            totalTax?: string;
            totalTaxSet?: string;
...
/** Context of the `update` action on the `shopifyOrder` model. */ export interface UpdateShopifyOrderActionContext extends AmbientContext {
    /**
  * The model this action is operating on
  */ model: NotYetTyped;
    /**
...
/** Context of the `delete` action on the `shopifyOrder` model. */ export interface DeleteShopifyOrderActionContext extends AmbientContext {
    /**
  * The model this action is operating on
  */ model: NotYetTyped;
    /**
